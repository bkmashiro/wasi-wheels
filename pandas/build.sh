...
cat >venv/lib/python3.14/site-packages/numpy/core/include/numpy/npy_interrupt.h <<'EOF'
...
sed -i '/#define NPY_CPU_AMD64/a\
    ...
    #define NPY_CPU_WASM' venv/lib/python3.14/site-packages/numpy/core/include/numpy/npy_cpu.h
